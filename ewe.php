...
echo color("purple","[♥] GUNAKAN TOKEN ANDA UNTUK MENGAKSES SC INI \n");
echo color("nevy","  [♡] JANGAN LUPA FOLLOW IG GUE YA : @Bananacreamy \n");
echo color("yellow","[♥] SCRIPT INI BERGUNA UNTUK CEK PAYLATER \n");
echo color("blue"," [♡] ADA KENDALA? LGSG CHAT TELEGRAM @BANANACREAMY \n");
echo color("purple"," [♥] BACA DOA DULU SEBELUM MULAI , OKAY?❣️😍❣️ \n");
echo color("green","# # # # # # # # # # # # # # # # # # # # # # # \n");
	echo "\n";
echo color("nevy","[+] TOKEN GJK LO TARO SINI : ");
...
$info = curl('https://api.gojekapi.com/v1/chat/profile', null, $header);
   ...
   echo "\n";
   echo color("purple","nama : ".$akun." \n");
   echo color("purple","nomer : 0".$nope." \n");
//CHECKER SALDO GOPAY
$detail = curl('https://api.gojekapi.com/wallet/profile/detailed', null, $header);
         $saldoo = json_decode($detail[0]);
                $saldo = $saldoo->data->balance;
                    echo color("yellow","SISAH GOPAY LO = $saldo \n");
...
$detail_voucher = curl('https://api.gojekapi.com/gopoints/v3/wallet/vouchers?limit=10&page=1', null, $header);
 ...
 $batas_voucher14 = $vouchers->data[14]->expiry_date;
       ...
       echo "
";
       echo color("yellow","LO PUNYA " . $total_voucher . " Voucher GOJEK
");
       echo "
";
       if ($total_voucher == 1) {
...
";
 ...
 echo "\n".color("nevy","MAU CEK PAYLATER?: y/n ");
        ...
        echo color("blue","===========(CHECK PAYLATER)===========")."\n";
        sleep (5);
 ...
 $money = $duit->data->credit_limit;
   ...
   echo color("nevy","LIMIT TERSEDIA = Rp".$money." \n");
...
echo "".color("red","UPGRADE DULU AKUNNYA CUK \n");
}
}
//SELESAI TOD, CAPE GUA NGECEKNYA
 function nama()
	{
	$ch = curl_init();
